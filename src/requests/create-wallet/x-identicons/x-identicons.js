...
export default class XIdenticons extends MixinRedux(XElement) {
    ...
    _onPropertiesChanged(changes) {
        ...
        if (requestType !== RequestTypes.CREATE_WALLET) return;
    ...
    async _generateIdenticons() {
        this.actions.clearVolatile(RequestTypes.CREATE_WALLET);
        this.actions.createVolatile(RequestTypes.CREATE_WALLET, 7);
    }
